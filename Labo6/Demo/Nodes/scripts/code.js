const setup = () => {
    ...
    console.log(p.firstElementChild.nodeName, p.firstElementChild.nodeType); // #text 3
    //geef mij het volgende element die op hetzelde niveau staat
    console.log(p.nextElementSibling.nodeName, p.nextElementSibling.nodeType); // #text 3
